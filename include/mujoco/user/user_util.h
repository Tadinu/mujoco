...
MJAPI bool mjuu_defined(const double num);

// compute linear address of M[g1][g2] where M is triangular n-by-n
// return -1 if inputs are invalid
MJAPI int mjuu_matadr(int g1, int g2, const int n);

// set 4D vector
MJAPI void mjuu_setvec(double* dest, const double x, const double y, const double z, const double w);
MJAPI void mjuu_setvec(float* dest, const double x, const double y, const double z, const double w);

// set 3D vector
MJAPI void mjuu_setvec(double* dest, const double x, const double y, const double z);
MJAPI void mjuu_setvec(float* dest, const double x, const double y, const double z);

// set 2D vector
MJAPI void mjuu_setvec(double* dest, const double x, const double y);

// copy double array
MJAPI void mjuu_copyvec(double* dest, const double* src, const int n);

// copy float array
MJAPI void mjuu_copyvec(float* dest, const float* src, const int n);

// zero array
MJAPI void mjuu_zerovec(double* dest, const int n);
...
MJAPI double mjuu_normvec(double* vec, const int n);
...
MJAPI void mjuu_frameinvert(double* newpos, double* newquat,
                            const double* oldpos, const double* oldquat);

// accumulate frame transformations
MJAPI void mjuu_frameaccum(double* pos, double* quat,
                     const double* addpos, const double* addquat);

// invert frame accumulation
MJAPI void mjuu_frameaccuminv(double* pos, double* quat,
                        const double* addpos, const double* addquat);
...
MJAPI void mjuu_offcenter(double* res, const double mass, const double* vec);
...
MJAPI double mju_updateFrame(double quat[4], double normal[3], const double edge[3],
...
MJAPI std::string mjuu_makefullname(std::string filedir, std::string meshdir, std::string filename);
