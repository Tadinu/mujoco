...
template <typename T>
MJAPI double mjuu_makenormal(double* normal, const T a[3], const T b[3], const T c[3]);
...
MJAPI double mjuu_updateFrame(double       quat[4],
                        double       normal[3],
                        const double edge[3],
                        const double tprv[3],
                        const double tnxt[3],
...
MJAPI std::string mjuu_combinePaths(const std::string& path1,
