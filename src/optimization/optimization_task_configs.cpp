...
std::map<Demos, Simulation::TaskConfiguration> OptimizationTaskConfigurations::demoNumToConfigMap = {
        {Demos::DEMO_WIND,          OptimizationTaskConfigurations::demoWInd},
        {Demos::DEMO_WIND_SIM2REAL, OptimizationTaskConfigurations::demoWindSim2Real},
        {Demos::DEMO_SPHERE_ROTATE, OptimizationTaskConfigurations::demoSphere},
        {Demos::DEMO_WIND_TSHIRT,   OptimizationTaskConfigurations::demoTshirt},
        {Demos::DEMO_WEAR_HAT,      OptimizationTaskConfigurations::demoHat},
        {Demos::DEMO_WEAR_SOCK,     OptimizationTaskConfigurations::demoSock},
        {Demos::DEMO_SLOPE_PERF,    OptimizationTaskConfigurations::demoSlope},
        {Demos::DEMO_DRESS_TWIRL,   OptimizationTaskConfigurations::demoDress},
};
