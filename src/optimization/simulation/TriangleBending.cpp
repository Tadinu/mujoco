...
void TriangleBending::projectBackward(const VecXd &x_vec, TripleVector &triplets) {
  Utils::insertIntoTriplets(triplets, grad, 3, 3, 0, 0, c_idx, p0_idx * 3);
  Utils::insertIntoTriplets(triplets, grad, 3, 3, 0, 3, c_idx, p1_idx * 3);
  Utils::insertIntoTriplets(triplets, grad, 3, 3, 0, 6, c_idx, p2_idx * 3);
  Utils::insertIntoTriplets(triplets, grad, 3, 3, 0, 9, c_idx, p3_idx * 3);
}
