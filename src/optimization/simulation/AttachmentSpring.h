#ifndef MUJOCO_SRC_OPTIMIZATION_ATTACHMENTSPRING_H
#define MUJOCO_SRC_OPTIMIZATION_ATTACHMENTSPRING_H
...
public:
    ...
    pArr(other.pArr), pFixedArr(other.pFixedArr), sqrtConstraintWeight(other.sqrtConstraintWeight) {
    }
...
#endif //MUJOCO_SRC_OPTIMIZATION_ATTACHMENTSPRING_H
