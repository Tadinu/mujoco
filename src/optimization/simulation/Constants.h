#ifndef MUJOCO_SRC_OPTIMIZATION_CONSTANTS_H
#define MUJOCO_SRC_OPTIMIZATION_CONSTANTS_H
...
static std::string OUTPUT_PARENT_FOLDER = "output/";
#endif //MUJOCO_SRC_OPTIMIZATION_CONSTANTS_H